...
export default {
  ...
  methods: {
    ...
    handleCalculate () {
      ...
      this.summary.push(`FP(f(x), [a, b], Ɛ) -> FP(${this.toPrintEq}, [${a}, ${b}], ${this.computedErrorTolerance})`);
      ...
      this.solution.push(`FP(f(x), [a, b], Ɛ) -> FP(${this.toPrintEq}, [${a}, ${b}], ${this.computedErrorTolerance})`);
